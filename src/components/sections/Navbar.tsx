      ...
      <div
        ...
        <div className="flex items-center bg-white border border-border shadow-sm rounded-xl px-6 py-3">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <a href={CTA_URL} target="_blank" rel="noopener noreferrer" className="text-[13px] font-semibold text-white transition-colors duration-200 px-4 py-1.5 cursor-pointer rounded-lg bg-[#e55310]">
              Richiedi accesso
            </a>
          </div>
        </div>
