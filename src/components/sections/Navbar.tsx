      ...
      >
        ...
        <div className="flex items-center bg-white border border-border shadow-sm rounded-xl px-6 py-3">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div className="relative">
              <button
                className="text-[13px] font-semibold text-secondary hover:text-dark transition-colors duration-200 px-3 py-1.5 border border-border rounded-lg cursor-pointer"
                onClick={() => setShowLoginTooltip((v) => !v)}
              >
                Accedi
              </button>
            ...
            <a href={CTA_URL} target="_blank" rel="noopener noreferrer" className="text-[13px] font-semibold text-white bg-primary hover:bg-primary-hover transition-colors duration-200 px-4 py-1.5 rounded-lg cursor-pointer">
              Richiedi accesso
            </a>
          </div>
        </div>
